...
class KalshiClient:
    ...
    def get(self, path: str, params: Dict[str, Any] = {}) -> Any:
        ...
        print("self.host+path: ",self.host+path)
...
class ExchangeClient(KalshiClient):
    def __init__(self, exchange_api_base: str, username: str, password: str):
        ...
        """You must log in before making authenticated calls. We store the token and pass it into each call."""
    ...
    #my attempt at getting a user balance
    def get_balance(self):
        base_url = "/v1/users/" + self.user_id + "/balance"
        print("this is the get_balance url ", base_url)
        bal = self.get(base_url)
        return bal
